class OpcoesPerguntaController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to opcoes_pergunta_path, status: :see_other, notice: "Opcoes perguntum was successfully destroyed." }
  ...
  private
    ...
    def opcoes_perguntum_params
      params.expect(opcoes_perguntum: [ :pergunta_id, :texto ])
    end
end
