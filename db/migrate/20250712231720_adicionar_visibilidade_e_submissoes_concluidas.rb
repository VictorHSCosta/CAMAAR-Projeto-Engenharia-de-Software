class AdicionarVisibilidadeESubmissoesConcluidas < ActiveRecord::Migration[8.0]
  def up
    ...
    add_index :formularios, [:escopo_visibilidade, :disciplina_id]
    ...
    add_index :submissoes_concluidas, [:user_id, :formulario_id], unique: true, name: 'index_submissoes_concluidas_unique'
  end
  ...
  def down
    ...
    remove_index :formularios, [:escopo_visibilidade, :disciplina_id]
